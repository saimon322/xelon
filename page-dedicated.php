                    ...
                    <div class="ds-item d-flex flex-direction">
                        ...
                        <div class="ds-price-row d-flex">
                            ...
                            <div class="ds-configure">
                                <a href="<?php echo $core_link;?>" target="_blank" class="<?php if($ds_change_color_r[0] == 'red') { echo "danger-btn"; } elseif ($ds_change_color_r[0] == 'green') { echo "success-btn"; } elseif ($ds_change_color_r[0] == 'blueberry') echo "bluberry-btn";
