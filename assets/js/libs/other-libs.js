            ...
            var l = function () {
                ...
                d = function () {
                    ...
                    n.wrap('<div class="' + s.settings.wrapperClass + '"><div class="bx-viewport"></div></div>'),
                        ...
                        n.css({ width: "horizontal" === s.settings.mode ? 1e3 * s.children.length + 215 + "%" : "auto", position: "relative" }),
                ...
                g = function () {
                    ...
                    if (s.settings.moveSlides > 0)
                        ...
                        else for (; e < s.children.length; ) ++t, (e = i + m()), (i += s.settings.moveSlides <= m() ? s.settings.moveSlides : m());
...
(function (t) {
    var e = {
            columns: 1,
            search: !1,
            searchOptions: { delay: 250, showOptGroups: !1, searchText: !0, searchValue: !1, onSearch: function (t) {} },
            texts: { placeholder: "Select options", search: "Search", selectedOptions: " selected", selectAll: "Select all", unselectAll: "Unselect all", noneSelected: "None Selected" },
            selectAll: !1,
            selectGroup: !1,
            minHeight: 200,
            maxHeight: null,
        ...
        (s.prototype = {
            load: function () {
                ...
                if (
                    ...
                    o.css({ maxWidth: e.options.maxWidth, minHeight: e.options.minHeight, maxHeight: n }),
                        ...
                        if ("OPTGROUP" == this.nodeName) {
                            ...
                            t(this)
                                ...
                                .each(function () {
                                    ...
                                    i.push({ name: t(this).text(), value: t(this).val(), checked: t(this).prop("selected"), attributes: o });
                                }),
                                a.push({ label: t(this).attr("label"), options: i });
                        } else {
                            ...
                            a.push({ name: t(this).text(), value: t(this).val(), checked: t(this).prop("selected"), attributes: o });
                        }
                    }),
                    e.loadOptions(a, !0, !1),
            ...
            loadOptions: function (e, i, o) {
                    ...
                    if (e.hasOwnProperty(l)) {
                        ...
                        if (d.hasOwnProperty("value")) {
                            if ((this.options.showCheckbox && this.options.checkboxAutoFit && c.addClass("ms-reflow"), this._addOption(c, d), o)) {
                                var p = t("<option/>", { value: d.value, text: d.name });
                            ...
                            var h = t("<optgroup/>", { label: d.label });
                            ...
                            d.options))
                                if (d.options.hasOwnProperty(f)) {
                                    ...
                                    if ((this.options.showCheckbox && this.options.checkboxAutoFit && g.addClass("ms-reflow"), m.hasOwnProperty("value") && (this._addOption(g, m), c.find("> ul").append(g), o))) {
                                        p = t("<option/>", { value: m.value, text: m.name });
                ...
                this._updatePlaceholderText(),
                    r.find("ul").css({ "column-count": "", "column-gap": "", "-webkit-column-count": "", "-webkit-column-gap": "", "-moz-column-count": "", "-moz-column-gap": "" }),
                    s.find("optgroup").length
                        ? (n.find("> li:not(.optgroup)").css({ float: "left", width: 100 / this.options.columns + "%" }),
                            n
                                .find("li.optgroup")
                                .css({ clear: "both" })
                                .find("> ul")
                                .css({ "column-count": this.options.columns, "column-gap": 0, "-webkit-column-count": this.options.columns, "-webkit-column-gap": 0, "-moz-column-count": this.options.columns, "-moz-column-gap": 0 }),
                            this._ieVersion() && this._ieVersion() < 10 && n.find("li.optgroup > ul > li").css({ float: "left", width: 100 / this.options.columns + "%" }))
                        : (n.css({ "column-count": this.options.columns, "column-gap": 0, "-webkit-column-count": this.options.columns, "-webkit-column-gap": 0, "-moz-column-count": this.options.columns, "-moz-column-gap": 0 }),
                            this._ieVersion() && this._ieVersion() < 10 && n.find("> li").css({ float: "left", width: 100 / this.options.columns + "%" })),
            ...
            _updatePlaceholderText: function () {
                if (this.updatePlaceholder) {
                    ...
                    var r = [];
                    for (var a in i) if (i.hasOwnProperty(a) && (r.push(t.trim(e.find('option[value="' + this._escapeSelector(i[a]) + '"]').text())), r.length >= this.options.maxPlaceholderOpts)) break;
                    s.text(r.join(", ")),
                        r.length
            ...
            _addOption: function (e, i) {
                var s = t("<div/>").html(i.name).text(),
                    n = t("<label/>", { for: "ms-opt-" + o }).html(i.name),
                    r = t("<input>", { type: "checkbox", title: s, id: "ms-opt-" + o, value: i.value });
...
(function (t, e, i) {
    ...
    (o.prototype = {
        ...
        _initShares: function () {
            this.shares = e.map(
                ...
                e.proxy(function (t) {
                    ...
                    return e.extend({ url: this.url, text: this.text }, i, t);
                }, this)
            );
        },
        ...
        _createShareLink: function (t) {
            var i = this._getShareStrategy(t).call(t, { shareUrl: this._getShareUrl(t) });
            return (
        ...
        _createShareLogo: function (t) {
            var i = t.logo,
                o = r.test(i) ? e("<img>").attr("src", t.logo) : e("<i>").addClass(i);
    ...
    (t = /^\(?([^)]*)\)?(?:(.)(d+))?$/),
        ...
        ((i = (function () {
            ...
            return (
                ...
                (i.prototype.resetFormat = function () {
                    ...
                    return (r = (l = o.slice(1, 4))[0]), (n = l[1]), (s = (null != (i = l[2]) ? i.length : void 0) || 0), (this.format = { repeating: r, radix: n, precision: s });
                }),
                ...
                (i.prototype.formatDigits = function (t) {
                    ...
                    else for (o = !this.format.precision || !r(t) || !1, n = 0, l = (c = t.toString().split("").reverse()).length; n < l; n++) "." === (e = c[n]) && (o = !0), this.addDigit(e, o);
                }),
                    ...
                    if (((y = this.value), (d = this.getFractionalDigitCount(y, t)) && ((t *= Math.pow(10, d)), (y *= Math.pow(10, d))), (o = t - y))) {
                        for (this.bindTransitionEnd(), n = this.getDigitCount(y, t), r = [], e = 0, p = k = 0; 0 <= n ? k < n : k > n; p = 0 <= n ? ++k : --k) {
                            if (((w = h(y / Math.pow(10, n - p - 1))), (a = (l = h(t / Math.pow(10, n - p - 1))) - w), Math.abs(a) > this.MAX_VALUES)) {
                                for (u = [], f = a / (this.MAX_VALUES + this.MAX_VALUES * e * 0.5), i = w; (a > 0 && i < l) || (a < 0 && i > l); ) u.push(Math.round(i)), (i += f);
        ...
        (i.init = function () {
            ...
            if (null != document.querySelectorAll) {
                for (r = [], o = 0, s = (e = document.querySelectorAll(i.options.selector || ".odometer")).length; o < s; o++) (t = e[o]), r.push((t.odometer = new i({ el: t, value: null != (n = t.innerText) ? n : t.textContent })));
                return r;
            }
        }),
