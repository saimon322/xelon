...
!(function (t) {
    ...
    return (
        ...
        (function (t, e) {
            var i,
                ...
                n = (t.Color = function (e, i, o, s) {
                    return new t.Color.fn.parse(e, i, o, s);
                }),
                r = {
                ...
                return (
                    ...
                    c(s, function (t, i) {
                        var s,
                            ...
                            l = n && i.parse(n),
                            d = i.space || "rgba";
                        if (l) return (s = o[d](l)), (o[r[d].cache] = s[r[d].cache]), (a = o._rgba = s._rgba), !1;
                    }),
                    a.length ? ("0,0,0,0" === a.join() && t.extend(a, i.transparent), o) : i[e]
                );
            }
            function h(t, e, i) {
            ...
            (d.style.cssText = "background-color:rgba(1,1,1,.5)"),
                (l.rgba = d.style.backgroundColor.indexOf("rgba") > -1),
                c(r, function (t, e) {
                    (e.cache = "_" + t), (e.props.alpha = { idx: 3, type: "percent", def: 1 });
                }),
                (n.fn = t.extend(n.prototype, {
                    parse: function (e, o, s, a) {
                        ...
                        var l = this,
                            ...
                            h = (this._rgba = []);
                        return (
                            void 0 !== o && ((e = [e, o, s, a]), (d = "array")),
                            "string" === d
                                ? this.parse(p(e) || i._default)
                                : "array" === d
                                ? (c(r.rgba.props, function (t, i) {
                                      h[i.idx] = u(e[i.idx], i);
                                  }),
                                  this)
                                : "object" === d
                                      ...
                                      e instanceof n
                                          ...
                                          : function (i, o) {
                                                ...
                                                c(o.props, function (t, i) {
                                                    ...
                                                    l[s] && t.inArray(null, l[s].slice(0, 3)) < 0 && ((l[s][3] = 1), o.from && (l._rgba = o.from(l[s])));
                                            }
                                  ),
                                  this)
                                : void 0
                    ...
                    is: function (t) {
                        ...
                        return (
                            c(r, function (t, s) {
                                ...
                                return (
                                    r &&
                                        ((n = o[s.cache] || (s.to && s.to(o._rgba)) || []),
                                        c(s.props, function (t, e) {
                    ...
                    transition: function (t, e) {
                        var i = n(t),
                            o = i._space(),
                            s = r[o],
                            l = 0 === this.alpha() ? n("transparent") : this,
                            d = l[s.cache] || s.to(l._rgba),
                            p = d.slice();
                        return (
                            (i = i[s.cache]),
                            c(s.props, function (t, o) {
                                var s = o.idx,
                                    n = d[s],
                                    r = i[s],
                                    l = a[o.type] || {};
                                null !== r && (null === n ? (p[s] = r) : (l.mod && (r - n > l.mod / 2 ? (n += l.mod) : n - r > l.mod / 2 && (n -= l.mod)), (p[s] = u((r - n) * e + n, o))));
                            }),
                            this[o](p)
                        );
                    },
                ...
                (r.hsla.to = function (t) {
                    ...
                    var e,
                        ...
                        u = 0.5 * c;
                    return (
                        (e = l === a ? 0 : o === a ? (60 * (s - n)) / d + 360 : s === a ? (60 * (n - o)) / d + 120 : (60 * (o - s)) / d + 240),
                        (i = 0 === d ? 0 : u <= 0.5 ? d / c : d / (2 - c)),
                ...
                (r.hsla.from = function (t) {
                    ...
                    var e = t[0] / 360,
                        ...
                        r = 2 * o - n;
                    return [Math.round(255 * h(r, n, e + 1 / 3)), Math.round(255 * h(r, n, e)), Math.round(255 * h(r, n, e - 1 / 3)), s];
                }),
                c(r, function (e, i) {
                    var s = i.props,
                        r = i.cache,
                    ...
                    (n.fn[e] = function (e) {
                        ...
                        var i,
                            o = t.type(e),
                            d = "array" === o || "object" === o ? e : arguments,
                            p = this[r].slice();
                        return (
                            c(s, function (t, e) {
                                var i = d["object" === o ? t : e.idx];
                                ...
                                (n.fn[i] = function (n) {
                                    ...
                                    return "undefined" === a
                                        ...
                                        : ("function" === a && ((n = n.call(this, c)), (a = t.type(n))),
                                          null == n && s.empty ? this : ("string" === a && (r = o.exec(n)) && (n = c + parseFloat(r[2]) * ("+" === r[1] ? 1 : -1)), (d[s.idx] = n), this[l](d)));
                                });
                        });
                }),
                (n.hook = function (e) {
                        ...
                        (t.cssHooks[i] = {
                            set: function (e, o) {
                                var s,
                                    r,
                                    a = "";
                                if ("transparent" !== o && ("string" !== t.type(o) || (s = p(o)))) {
                                    if (((o = n(s || o)), !l.rgba && 1 !== o._rgba[3])) {
                            ...
                            (t.fx.step[i] = function (e) {
                                e.colorInit || ((e.start = n(e.elem, i)), (e.end = n(e.end)), (e.colorInit = !0)), t.cssHooks[i].set(e.elem, e.start.transition(e.end, e.pos));
                            });
                    });
                }),
                ...
                (t.cssHooks.borderColor = {
                    expand: function (t) {
                        var e = {};
                        return (
                            c(["Top", "Right", "Bottom", "Left"], function (i, o) {
                                e["border" + o + "Color"] = t;
                            }),
                            e
                        );
        ...
        (function () {
            ...
            function n(e) {
                var i,
                    ...
                    n = {};
                if (s && s.length && s[0] && s[s[0]]) for (o = s.length; o--; ) "string" == typeof s[(i = s[o])] && (n[t.camelCase(i)] = s[i]);
                else for (i in s) "string" == typeof s[i] && (n[i] = s[i]);
                return n;
            }
            t.each(["borderLeftStyle", "borderRightStyle", "borderBottomStyle", "borderTopStyle"], function (e, o) {
                t.fx.step[o] = function (t) {
                    (("none" !== t.end && !t.setAttr) || (1 === t.pos && !t.setAttr)) && (i.style(t.elem, o, t.end), (t.setAttr = !0));
                };
            }),
                t.fn.addBack ||
                                ...
                                return (
                                    ...
                                    (this.diff = (function (e, i) {
                                        var o,
                                            n,
                                            r = {};
                                        for (o in i) (n = i[o]), e[o] !== n && (s[o] || (!t.fx.step[o] && isNaN(parseFloat(n))) || (r[o] = n));
                                        return r;
                                    })(this.start, this.end)),
                                    this
                                );
                ...
                t.fn.extend({
                    addClass:
                        ((e = t.fn.addClass),
                        function (i, o, s, n) {
                            return o ? t.effects.animateClass.call(this, { add: i }, o, s, n) : e.apply(this, arguments);
                        }),
                    removeClass: (function (e) {
                        return function (i, o, s, n) {
                            return arguments.length > 1 ? t.effects.animateClass.call(this, { remove: i }, o, s, n) : e.apply(this, arguments);
                        };
                    })(t.fn.removeClass),
                    toggleClass: (function (e) {
                        return function (i, o, s, n, r) {
                            return "boolean" == typeof o || void 0 === o
                                ? s
                                    ? t.effects.animateClass.call(this, o ? { add: i } : { remove: i }, s, n, r)
                                    : e.apply(this, arguments)
                                : t.effects.animateClass.call(this, { toggle: i }, o, s, n);
                        };
                    })(t.fn.toggleClass),
                    switchClass: function (e, i, o, s, n) {
                        return t.effects.animateClass.call(this, { add: i, remove: e }, o, s, n);
                    },
                });
        })(),
        (function () {
            ...
            function i(e, i, o, s) {
                return (
                    ...
                    (e = { effect: e }),
                    null == i && (i = {}),
                    t.isFunction(i) && ((s = i), (o = null), (i = {})),
                    ("number" == typeof i || t.fx.speeds[i]) && ((s = o), (o = i), (i = {})),
                    t.isFunction(o) && ((s = o), (o = null)),
                    i && t.extend(e, i),
                    (o = o || i.duration),
            ...
            function s(t, e) {
                var i = e.outerWidth(),
                    o = e.outerHeight(),
                    s = /^rect\((-?\d*\.?\d*px|-?\d+%|auto),?\s*(-?\d*\.?\d*px|-?\d+%|auto),?\s*(-?\d*\.?\d*px|-?\d+%|auto),?\s*(-?\d*\.?\d*px|-?\d+%|auto)\)$/.exec(t) || ["", 0, i, o, 0];
                return { top: parseFloat(s[1]) || 0, right: "auto" === s[2] ? i : parseFloat(s[2]), bottom: "auto" === s[3] ? o : parseFloat(s[3]), left: parseFloat(s[4]) || 0 };
            }
            t.expr &&
                t.expr.filters &&
                ...
                !1 !== t.uiBackCompat &&
                    t.extend(t.effects, {
                        save: function (t, e) {
                            for (var i = 0, o = e.length; i < o; i++) null !== e[i] && t.data("ui-effects-" + e[i], t[0].style[e[i]]);
                        },
                        restore: function (t, e) {
                            for (var i, o = 0, s = e.length; o < s; o++) null !== e[o] && ((i = t.data("ui-effects-" + e[o])), t.css(e[o], i));
                        },
                        ...
                        createWrapper: function (e) {
                            ...
                            var i = { width: e.outerWidth(!0), height: e.outerHeight(!0), float: e.css("float") },
                                o = t("<div></div>").addClass("ui-effects-wrapper").css({ fontSize: "100%", background: "transparent", border: "none", margin: 0, padding: 0 }),
                            ...
                            return (
                                ...
                                "static" === e.css("position")
                                    ? (o.css({ position: "relative" }), e.css({ position: "relative" }))
                ...
                t.extend(t.effects, {
                    ...
                    scaledDimensions: function (t, e, i) {
                        ...
                        return { height: t.height() * s, width: t.width() * o, outerHeight: t.outerHeight() * s, outerWidth: t.outerWidth() * o };
                    },
                    ...
                    createPlaceholder: function (e) {
                        ...
                        return (
                            ...
                            e.css({ position: o, left: s.left, top: s.top }),
                            i
                        );
                    },
                    ...
                    setTransition: function (e, i, o, s) {
                        return (
                            (s = s || {}),
                ...
                t.fn.extend({
                    effect: function () {
                        var e = i.apply(this, arguments),
                            ...
                            c = function (e) {
                                var i = t(this),
                                    o = t.effects.mode(i, l) || s;
                                i.data("ui-effects-animated", !0), d.push(o), s && ("show" === o || (o === s && "hide" === o)) && i.show(), (s && "none" === o) || t.effects.saveStyle(i), t.isFunction(e) && e();
                            };
                        if (t.fx.off || !o)
                            return l
                                ? this[l](e.duration, a)
                        ...
                        function u(i) {
                            var n = t(this);
                            function r() {
                                t.isFunction(a) && a.call(n[0]), t.isFunction(i) && i();
                            }
                            (e.mode = d.shift()),
                                !1 === t.uiBackCompat || s
                                    ? "none" === e.mode
                                        ? (n[l](), r())
                                        : o.call(n[0], e, function () {
                                              n.removeData("ui-effects-animated"), t.effects.cleanUp(n), "hide" === e.mode && n.hide(), r();
                                          })
                                    : (n.is(":hidden") ? "hide" === l : "show" === l)
                                    ? (n[l](), r())
                                    : o.call(n[0], e, r);
                        }
                        return !1 === n ? this.each(c).each(u) : this.queue(r, c).queue(r, u);
                    },
                    show: (function (t) {
                        return function (e) {
                    ...
                    transfer: function (e, i) {
                        var o = t(this),
                            ...
                            l = n ? r.scrollLeft() : 0,
                            d = s.offset(),
                            c = { top: d.top - a, left: d.left - l, height: s.innerHeight(), width: s.innerWidth() },
                            u = o.offset(),
                            p = t("<div class='ui-effects-transfer'></div>")
                                .appendTo("body")
                                .addClass(e.className)
                                .css({ top: u.top - a, left: u.left - l, height: o.innerHeight(), width: o.innerWidth(), position: n ? "fixed" : "absolute" })
        ...
        ((e = (function () {
                            ...
                            .each(function (s) {
                                ...
                                t(this).attr({ role: "presentation" }),
                                    t(this)
                                        .find("button")
                                        .first()
                                        .attr({ role: "tab", id: "slick-slide-control" + e.instanceUid + s, "aria-controls": "slick-slide" + e.instanceUid + n, "aria-label": s + 1 + " of " + i, "aria-selected": null, tabindex: "-1" });
                            })
                            .eq(e.currentSlide)
                            .find("button")
            ...
            (t.fn.slick = function () {
                var t,
                    ...
                    r = o.length;
                for (t = 0; t < r; t++) if (("object" == typeof s || void 0 === s ? (o[t].slick = new e(o[t], s)) : (i = o[t].slick[s].apply(o[t].slick, n)), void 0 !== i)) return i;
                return o;
            });
    }),
    (function (t, e) {
    ...
    (function (t, e) {
        ...
        function i() {
            if (!l) {
                ...
                n.appendChild(i);
                var r = e(i);
                (s = 200 == Math.round(t(r.width))), (o.isBoxSizeOuter = s), n.removeChild(i);
            }
        }
        function o(o) {
            if ((i(), "string" == typeof o && (o = document.querySelector(o)), o && "object" == typeof o && o.nodeType)) {
                ...
                for (var d = (l.isBorderBox = "border-box" == n.boxSizing), c = 0; c < a; c++) {
                    var u = r[c],
                        p = n[u],
                        h = parseFloat(p);
                    l[u] = isNaN(h) ? 0 : h;
                ...
                var f = l.paddingLeft + l.paddingRight,
                    ...
                    b = d && s,
                    k = t(n.width);
                !1 !== k && (l.width = k + (b ? 0 : f + y));
                var S = t(n.height);
                return !1 !== S && (l.height = S + (b ? 0 : m + w)), (l.innerWidth = l.width - (f + y)), (l.innerHeight = l.height - (m + w)), (l.outerWidth = l.width + g), (l.outerHeight = l.height + v), l;
            }
        }
        var s,
            n =
            ...
            (i.htmlInit = function (e, o) {
                i.docReady(function () {
                    ...
                    d.forEach(function (t) {
                        var i,
                            n = t.getAttribute(r) || t.getAttribute(c);
                        try {
                            i = n && JSON.parse(n);
                        } catch (e) {
    ...
    (function (t, e) {
        ...
        var o = document.documentElement.style,
            ...
            a = { transform: n, transition: s, transitionDuration: s + "Duration", transitionProperty: s + "Property", transitionDelay: s + "Delay" },
    ...
    (function (t, e) {
        "use strict";
        "function" == typeof define && define.amd
            ? define("outlayer/outlayer", ["ev-emitter/ev-emitter", "get-size/get-size", "fizzy-ui-utils/utils", "./item"], function (i, o, s, n) {
                  return e(t, i, o, s, n);
              })
            : "object" == typeof module && module.exports
        ...
        o.extend(p, e.prototype),
            ...
            (p._getElementOffset = function (t) {
                var e = t.getBoundingClientRect(),
                    ...
                    s = i(t);
                return { left: e.left - o.left - s.marginLeft, top: e.top - o.top - s.marginTop, right: o.right - e.right - s.marginRight, bottom: o.bottom - e.bottom - s.marginBottom };
            }),
            ...
            o.debounceMethod(n, "onresize", 100),
            (p.resize = function () {
            ...
            (n.create = function (t, e) {
                var i = r(n);
                return (
                    (i.defaults = o.extend({}, n.defaults)),
                    o.extend(i.defaults, e),
                    (i.compatOptions = o.extend({}, n.compatOptions)),
                    (i.namespace = t),
                    (i.data = n.data),
                    (i.Item = r(s)),
                    o.htmlInit(i, t),
                        ...
                        return function (i, o) {
                            for (var s = 0; s < t.length; s++) {
                                var n = t[s],
                                    r = i.sortData[n],
                                    a = o.sortData[n];
                                if (r > a || r < a) return (r > a ? 1 : -1) * ((void 0 !== e[n] ? e[n] : e) ? 1 : -1);
                            }
                            return 0;
                        };
        ...
        (t.cleanData = (function (e) {
            return function (i) {
                ...
                for (n = 0; null != (s = i[n]); n++)
                    try {
                        (o = t._data(s, "events")) && o.remove && t(s).triggerHandler("remove");
                    } catch (t) {}
                e(i);
            };
        })(t.cleanData)),
            (t.widget = function (e, i, o) {
                ...
                return (
                    o || ((o = i), (i = t.Widget)),
                    t.isArray(o) && (o = t.extend.apply(null, [{}].concat(o))),
                    (t.expr[":"][d.toLowerCase()] = function (e) {
                        return !!t.data(e, d);
                    }),
                    (t[l] = t[l] || {}),
                    (s = t[l][e]),
                    ...
                    (n.prototype = t.widget.extend(r, { widgetEventPrefix: (s && r.widgetEventPrefix) || e }, a, { constructor: n, namespace: l, widgetName: e, widgetFullName: d })),
                    s
            ...
            (t.widget.extend = function (e) {
                for (var o, s, n = i.call(arguments, 1), r = 0, a = n.length; a > r; r++)
                    for (o in n[r]) (s = n[r][o]), n[r].hasOwnProperty(o) && void 0 !== s && (e[o] = t.isPlainObject(s) ? (t.isPlainObject(e[o]) ? t.widget.extend({}, e[o], s) : t.widget.extend({}, s)) : s);
                return e;
            }),
            (t.widget.bridge = function (e, o) {
                var s = o.prototype.widgetFullName || e;
                t.fn[e] = function (n) {
                    ...
                    return (
                        r
                            ...
                            : (a.length && (n = t.widget.extend.apply(null, [n].concat(a))),
                              this.each(function () {
                                  var e = t.data(this, s);
                                  e ? (e.option(n || {}), e._init && e._init()) : t.data(this, s, new o(n, this));
                              })),
                        l
                    );
                };
            ...
            (t.Widget.prototype = {
                ...
                option: function (e, i) {
                    ...
                    if ("string" == typeof e)
                        if (((r = {}), (o = e.split(".")), (e = o.shift()), o.length)) {
                            for (s = r[e] = t.widget.extend({}, this.options[e]), n = 0; o.length - 1 > n; n++) (s[o[n]] = s[o[n]] || {}), (s = s[o[n]]);
                ...
                _setOptionClasses: function (e) {
                    var i, o, s;
                    for (i in e) (s = this.classesElementLookup[i]), e[i] !== this.options.classes[i] && s && s.length && ((o = t(s.get())), this._removeClass(s, i), o.addClass(this._classes({ element: o, keys: i, classes: e, add: !0 })));
                },
                    ...
                    function i(i, n) {
                        ...
                        for (a = 0; i.length > a; a++)
                            (r = s.classesElementLookup[i[a]] || t()),
                                ...
                                o.push(i[a]),
                                n && e.classes[i[a]] && o.push(e.classes[i[a]]);
                    }
                    var o = [],
                        s = this;
                    return (
                ...
                _on: function (e, i, o) {
                    ...
                    "boolean" != typeof e && ((o = i), (i = e), (e = !1)),
                        ...
                        t.each(o, function (o, r) {
                            ...
                            var l = o.match(/^([\w:-]*)\s*(.*)$/),
                                d = l[1] + n.eventNamespace,
                                c = l[2];
                            c ? s.on(d, c, a) : i.on(d, a);
                        });
                },
                _off: function (e, i) {
                ...
                _trigger: function (e, i, o) {
                    var s,
                        n,
                        r = this.options[e];
                    if (((o = o || {}), ((i = t.Event(i)).type = (e === this.widgetEventPrefix ? e : this.widgetEventPrefix + e).toLowerCase()), (i.target = this.element[0]), (n = i.originalEvent))) for (s in n) s in i || (i[s] = n[s]);
            ...
            t.widget("ui.slider", t.ui.mouse, {
                ...
                _createHandles: function () {
                    var e,
                        ...
                        n = [];
                    for (i = (o.values && o.values.length) || 1, s.length > i && (s.slice(i).remove(), (s = s.slice(0, i))), e = s.length; i > e; e++) n.push("<span tabindex='0'></span>");
                ...
                _mouseCapture: function (e) {
                    ...
                    return (
                        ...
                        this.handles.each(function (e) {
                            var i = Math.abs(o - d.values(e));
                            (s > i || (s === i && (e === d._lastChangedValue || d.values(e) === c.min))) && ((s = i), (n = t(this)), (r = e));
                        }),
                        !1 !== this._start(e, r) &&
                ...
                _normValueFromMouse: function (t) {
                    ...
                    return (
                        ...
                        (n = this._valueMin() + o * s),
                        this._trimAlignValue(n)
                    );
                },
                _uiHash: function (t, e, i) {
                    var o = { handle: this.handles[t], handleIndex: t, value: void 0 !== e ? e : this.value() };
                ...
                _slide: function (t, e, i) {
                    var o,
                        s = this.value(),
                        n = this.values();
                    this._hasMultipleValues() && ((o = this.values(e ? 0 : 1)), (s = this.values(e)), 2 === this.options.values.length && !0 === this.options.range && (i = 0 === e ? Math.min(o, i) : Math.max(o, i)), (n[e] = i)),
                        i !== s && !1 !== this._trigger("slide", t, this._uiHash(e, i, n)) && (this._hasMultipleValues() ? this.values(e, i) : this.value(i));
                },
                _stop: function (t, e) {
                ...
                values: function (e, i) {
                    ...
                    for (o = this.options.values, s = arguments[0], n = 0; o.length > n; n += 1) (o[n] = this._trimAlignValue(s[n])), this._change(null, n);
                    this._refreshValue();
                },
                _setOption: function (e, i) {
                    ...
                    switch (
                        ...
                        case "value":
                            ...
                            break;
                        case "values":
                            for (this._animateOff = !0, this._refreshValue(), o = s - 1; o >= 0; o--) this._change(null, o);
                            this._animateOff = !1;
                            break;
                        case "step":
                        case "min":
                ...
                _values: function (t) {
                    ...
                    if (this._hasMultipleValues()) {
                        for (i = this.options.values.slice(), o = 0; i.length > o; o += 1) i[o] = this._trimAlignValue(i[o]);
                        return i;
                    }
                    return [];
                },
                    ...
                    this._hasMultipleValues()
                        ? this.handles.each(function (o) {
                              (i = ((l.values(o) - l._valueMin()) / (l._valueMax() - l._valueMin())) * 100),
                                  ...
                                  t(this).stop(1, 1)[d ? "animate" : "css"](c, a.animate),
                                  !0 === l.options.range &&
                                      ("horizontal" === l.orientation
                                          ? (0 === o && l.range.stop(1, 1)[d ? "animate" : "css"]({ left: i + "%" }, a.animate), 1 === o && l.range[d ? "animate" : "css"]({ width: i - e + "%" }, { queue: !1, duration: a.animate }))
                                          : (0 === o && l.range.stop(1, 1)[d ? "animate" : "css"]({ bottom: i + "%" }, a.animate), 1 === o && l.range[d ? "animate" : "css"]({ height: i - e + "%" }, { queue: !1, duration: a.animate }))),
                                  (e = i);
                          })
                        : ((o = this.value()),
                          (s = this._valueMin()),
                ...
                _handleEvents: {
                    keydown: function (e) {
                        ...
                        switch (((s = this.options.step), (i = o = this._hasMultipleValues() ? this.values(n) : this.value()), e.keyCode)) {
                            case t.ui.keyCode.HOME:
                                o = this._valueMin();
                                break;
                            case t.ui.keyCode.END:
        ...
        t(function () {
            ...
            t(document).ready(function () {
                ...
                if (
                    ...
                    t(".slider-tm").slick({ dots: !0, infinite: !0, speed: 300, slidesToShow: 1, adaptiveHeight: !0, speed: 500 }),
                    t(".bg-slider-company .bg-one").length > 1)
                )
                    var c = !0;
                else c = !1;
                t(".bg-slider-company").slick({ dots: c, arrows: !1, infinite: !0, speed: 300, slidesToShow: 1, adaptiveHeight: !0, speed: 500 }),
                    t(".aub-td").append(t(".bg-slider-company .slick-dots")),
                    t(".popup-video").magnificPopup({ type: "iframe", mainClass: "mfp-fade mp-video", removalDelay: 160, preloader: !1, fixedContentPos: !1 }),
                    t('[href*="#send-message"]').addClass("popup-message").attr("href", "#popup-message-call"),
                    t('[href*="#schedule-a-call"]').addClass("popup-call").attr("href", "#popup-message-call"),
                    t(".popup-message").magnificPopup({
                        type: "inline",
                        midClick: !0,
                        mainClass: "mfp-fade",
                        callbacks: {
                            open: function () {
                                t(".contact-modal .tab:first-child").click();
                            },
                        },
                    }),
                    t(".popup-call").magnificPopup({
                        type: "inline",
                        midClick: !0,
                        mainClass: "mfp-fade",
                        callbacks: {
                            open: function () {
                                t(".contact-modal .tab:last-child").click();
                            },
                        },
                    }),
                    t(".tab")
                    ...
                    t(".gallery-slider").slick({ infinite: !0, slidesToShow: 1, slidesToScroll: 1, dots: !0, nextArrow: '<i class="las la-angle-right"></i>', prevArrow: '<i class="las la-angle-left"></i>', adaptiveHeight: !0 }),
            ...
            var e,
                i = document.getElementsByClassName("accordion");
            ...
            t(".coutdown").each(function () {
                ...
                t(".number:not(#count3)").each(function () {
                    t(this)
                        .prop("coutdown", 0)
                        .animate(
                            { Counter: t(this).text() },
                    ...
                    t.ajax({
                        ...
                        success: function (e) {
                            t("#ajax-projects").html(e),
                                ...
                                t(".cp-slider").slick({ infinite: !0, slidesToShow: 3, slidesToScroll: 1, responsive: [{ breakpoint: 767, settings: { slidesToShow: 1, slidesToScroll: 1 } }] });
                        },
                    });
                }),
                ...
                t.ajax(a)
                    .done(function (e) {
                        ...
                        if (promocode.status == 'true'){
                            promo = '&promocode=' + promocode.promo;
                        }
                        i.closest("form").find(".msg").html(e.message).fadeIn("slow"),
                            ...
                            (document.location.href = "https://vdc.xelon.ch/demo?email=" + o + promo),
                            t("#open-popup .modal-area").css("padding-bottom", "60px"),
                            // (postForm("https://vdc.xelon.ch/api/user/trial/subscribe?email=" + o + "&cid=" + n + "&referrer=" + r + promo)),
                            i.remove();
                    })
                    .fail(function (t, e, o) {
            ...
            if (
                ...
                t(".pi-item").first().addClass('active'),
                t(".pi-item").first().children(".pi-item-text").show(),
                ...
                t(function () {
                    t(".home .recent-news").addClass("hide-news"),
                        t(".home .recent-news #load-more-events").click(function () {
                            t(".home .recent-news").removeClass("hide-news");
                        });
                }),
