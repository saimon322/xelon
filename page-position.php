    ...
    <div class="position-text">
      <div class="container">
        ...
        <div class="pt-row">
          ...
          <a href="#modal-position" class="btn-next open-popup-link"><?php echo the_field('position_btn_apply'); ?></a>
        </div>
      </div>
    </div>
    ...
    <div class="position-info">
      <div class="container">
        ...
        <div class="pt-row">
          ...
          <a href="#modal-position" class="btn-next"><?php echo the_field('position_btn_apply1'); ?></a>
        </div>
      </div>
    </div>
