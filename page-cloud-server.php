<?php
/**
 * Template Name: Product page - Cloud server
 */
get_header();
?>
  ...
  <section class="faq-vdc faq-vdc-new">
    <div class="container">
      <div class="accordion-area d-flex justify-center">
        ...
        <div class="accordion-section">
          <?php
          $adv_acc_img = get_field('adv_acc_img');
          if( !empty($adv_acc_img) ): ?>
          <img src="<?php echo $adv_acc_img['url']; ?>" alt="<?php echo $adv_acc_img['alt']; ?>">
          <?php endif; ?>
        </div>
      </div>
    </div>
